...
<p>3. ${ph('Итоговые распоряжения', 'text')}</p>`,
    ...
    // ── 10. Судебный ордер ────────────────────────────────────────────────────
    // Единый документ: шапка → вводная часть → АВТОРИЗАЦИЯ → СУБЪЕКТЫ ОРДЕРА.
    order: `<p style="text-align:center"><strong>ОКРУЖНОЙ СУД ШТАТА САН-АНДРЕАС</strong></p>
<p>&nbsp;</p>
<p style="text-align:center"><strong>СУДЕБНЫЙ ОРДЕР</strong></p>
<p style="text-align:center"><strong>Arrest and search</strong></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p style="text-align:center"><strong>СУБЪЕКТЫ ОРДЕРА</strong></p>
<p>&nbsp;</p>
