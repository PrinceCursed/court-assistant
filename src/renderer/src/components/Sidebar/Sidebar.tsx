...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14"/></svg>,
        label: 'Доп. шаблоны', view: { type: 'additional-templates' } as View, section: 'additional-templates',
      },
    ],
  },
]
